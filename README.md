...
The portal uses the same DuckDuckGo-powered open-web search flow as the CLI, shows the matched prices in a table, and provides a download link for a fresh
